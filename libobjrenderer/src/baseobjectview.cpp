...
float BaseObjectView::VERT_SPACING=2.0f;
float BaseObjectView::HORIZ_SPACING=2.0f;
float BaseObjectView::DEFAULT_FONT_SIZE=9.0f;
float BaseObjectView::OBJ_BORDER_WIDTH=0.80f;
